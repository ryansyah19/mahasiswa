...
?>
				...
				<tr><td>Deskripsi : <?php echo $data['deskripsi'];?></td></tr>
				<tr><td>Thumbnail : <?php echo $data['thumbnail'];?></td></tr>
				<tr><td>Url Thumbnail : <?php echo $data['urlthumbnail'];?></td></tr>
				<tr><td>PDF : <?php echo $data['pdf'];?></td></tr>
				<tr><td>Url PDF : <?php echo $data['urlpdf'];?></td></tr>
			</table>
			<a href ='index2.php?=#second'>
