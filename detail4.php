    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index2.php?=#third">Admin</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
...
include "pages/examples/koneksi.php";
$id = $_GET['id'];
$siswa="SELECT * FROM data where id='$id'";
...
<tr><td>Nama : <?php echo $data['nama'];?></td></tr>
				...
				<tr><td>Sekolah : <?php echo $data['sekolah'];?></td></tr>
				<tr><td>Alamat : <?php echo $data['alamat'];?></td></tr>
				<tr><td>No.HP : <?php echo $data['nohp'];?></td></tr>
				<tr><td>Nama Guru: <?php echo $data['namaguru'];?></td></tr>
				<tr><td>No.HP Guru : <?php echo $data['nohpguru'];?></td></tr>
</table>
