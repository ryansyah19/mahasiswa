                        ...
                        <div class="body">
							...
							<input type="hidden" name="id" value="<?php echo $id;?>">
                                ...
                                <div class="form-group form-float">
								 ...
								 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="namaguru" class="form-control" value="<?php echo $data['namaguru'];?>" required/>
								 ...
								 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="nohpguru" class="form-control" value="<?php echo $data['nohpguru'];?>" required/>
								 ...
								 <div class="form-group form-float">
													...
													<?php echo "<a href='".$data['urlfoto']."'><img src='".$data['urlfoto']."'width='100' height='100'>";?>
