                            ...
                            <div class="table-responsive">
								<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									<tbody>
										...
										$query="SELECT user.username, user.id, data.id, data.nama, data.nisn, data.kelas, data.sekolah, 
												data.alamat, data.nohp, data.namaguru, data.nohpguru 
												FROM data 
												INNER JOIN user 
												ON data.id = user.id
