			   ...
			   <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-12">
                   ...
                   <?php  
					include "pages/examples/koneksi.php";
					$id = $_GET['id'];
					$siswa="SELECT * FROM info where id='$id'";
					$hasil=mysqli_query($koneksi,$siswa);
					$data= mysqli_fetch_array($hasil);
					$urlkonten = "";
					$urlkonten=$data['urlpdf']; 
					?>
				<h4 style="text-align:center; "><?php echo "<a href='".$data['urlthumbnail']."'><img src='".$data['urlthumbnail']."'width='30%' height='30%'></a>";?></h4>
				<h4 style="text-align:center; font-size:18px; padding:40px;"><?php echo $data['deskripsi'];?></h4>
					<div id="materipdf" style="text-align:center;"></div>
		<script src="js/pdf/pdfobject.js"></script>
                <script>
                     var options = {
                        ...
                        PDFObject.embed("<?php echo $urlkonten; ?>", "#materipdf", options);
                    </script>
				
			<a href ='daftar_info.php'>
				<input type="button" name="button" class="btn btn-primary m-t-15 waves-effect" value="Kembali"></input></a>
                </div>
                <!-- #END# Task Info -->
				</div>
			</div>
